...
#
## 筛选出纯字母的行，即商家
#merchants_df = merged[~merged['to_randomly_generated_account'].apply(lambda x: x.isnumeric())]
#
## 重置索引
...
#merchants_df_sorted.to_csv('D:/MiniProjectSource/JIA_TIAN/merchants_sorted.csv', index=False)
